...
| **Carried debt from A1.1** | None. The `create_work_order_from_estimate` regression was fixed inside A1.1 (migration `20260816173237`) rather than carried into A1.2. |
