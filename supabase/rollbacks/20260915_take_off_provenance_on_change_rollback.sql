-- ROLLBACK for 2026-09-15 take_off_provenance_on_change.
-- Both bodies taken verbatim from the md5-verified migration files that created what is live
-- (set_take_off_decision: 20260914230647; generate_take_off: 20260915005153), confirmed against
-- prosrc md5 before applying. Signatures unchanged.
--
-- RESTORING THIS RE-OPENS: re-saving or re-ticking an unchanged decision rewrites its source to
-- human/generate_take_off with a fresh decided_by and decided_at (proved 2026-09-15 on the one live
-- decision, rolled back: backfill -> human).
