...
-- capability flags (hide $)" (Phase A / Roles & access).
--
...
-- immediately before writing this migration: neither org_members.permissions
-- nor has_capability() existed yet, so this is a plain CREATE, not an
-- overload risk.
