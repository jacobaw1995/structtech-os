...
--
-- Interaction 1 from the resolved design: widen the C3 edit gate so a
-- capability-granted caller can edit ANY lead in the org, not just leads
-- she owns, WITHOUT promoting her to a manager role.
--
...
-- migration. Confirmed single overload each. No drop-first needed.
